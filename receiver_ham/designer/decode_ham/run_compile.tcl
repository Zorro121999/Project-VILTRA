...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Users\user\Documents\ISISA\optical_transmission\receiver_ham\synthesis\decode_ham.vm"}
set_compile_info \
    -category {"Options"} \
...
set_compile_info \
    ...
    -value {"10"}
compile \
    -desdir {C:\Users\user\Documents\ISISA\optical_transmission\receiver_ham\designer\decode_ham} \
    -design decode_ham \
    -fam SmartFusion2 \
    -die PA4M1000_N \
    -pkg tq144 \
