...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Users\user\Documents\ISISA\optical_transmission\transmitter_maker\synthesis\transmitter.vm"}
set_compile_info \
    -category {"Options"} \
...
set_compile_info \
    ...
    -value {"10"}
compile \
    -desdir {C:\Users\user\Documents\ISISA\optical_transmission\transmitter_maker\designer\transmitter} \
    -design transmitter \
    -fam SmartFusion2 \
    -die PA4M1000_N \
    -pkg tq144 \
